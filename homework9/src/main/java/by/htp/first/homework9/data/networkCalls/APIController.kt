package by.htp.first.homework9.data.networkCalls

import by.htp.first.homework9.data.WeatherDataFromAPIImpl
import by.htp.first.homework9.data.WeatherFromApi
import by.htp.first.homework9.data.networkCalls.APIController.RetrofitHolder.retrofit
