...
import by.htp.first.homework6_1.database.WorkDatabaseDAO
...
class EditWorkActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        dao = CarDatabase.getDataBase(this).getWorkDatabaseDAO()
    ...
    private fun fillPage() {
        workObject?.let {
            ...
            when (progress) {
                ...
                getString(R.string.completed) -> completedImageView.setColorFilter(getColor(R.color.completeColor))
            }
        }
    }
    ...
    private fun completedSetColor() {
        ...
        progress = getString(R.string.completed)
    }
