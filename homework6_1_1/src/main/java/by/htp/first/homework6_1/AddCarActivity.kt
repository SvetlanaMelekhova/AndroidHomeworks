...
import by.htp.first.homework6_1.database.CarDatabaseDAO
import by.htp.first.homework6_1.entity.Car
import com.google.android.material.snackbar.Snackbar
import java.io.File
import java.util.UUID

private const val AUTHORITY: String = "by.htp.first.homework6_1.fileprovider"
...
class AddCarActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        dao = CarDatabase.getDataBase(this).getCarDatabaseDAO()
        ...
        buttonAdd.setOnClickListener {
            if (carOwnerName.text.isNotEmpty() && carModelName.text.isNotEmpty() && carPlateNumber.text.isNotEmpty()) {
                ...
                Snackbar.make(buttonAdd, getString(R.string.fill_out_form), Snackbar.LENGTH_LONG)
                    .show()
            }
        }
